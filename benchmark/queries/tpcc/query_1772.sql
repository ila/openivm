...
SELECT d.D_W_ID, c.C_ID, RANK() OVER (PARTITION BY d.D_W_ID ORDER BY c.C_ID) AS rnk FROM DISTRICT d JOIN CUSTOMER c ON d.D_W_ID = c.C_W_ID AND d.D_ID = c.C_D_ID;
