...
SELECT c.C_ID, o.O_OL_CNT, RANK() OVER (PARTITION BY c.C_ID ORDER BY o.O_OL_CNT) AS rnk FROM CUSTOMER c JOIN OORDER o ON c.C_ID = o.O_C_ID AND c.C_W_ID = o.O_W_ID;
